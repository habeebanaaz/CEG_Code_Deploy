...
from flows_filter_files import filtered_files
...
container_name= azure_storage_config['flows_container_name'] 
local_directory = azure_storage_config['flows_local_directory']

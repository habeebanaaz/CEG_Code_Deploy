...
from UGS_filter_files import filtered_files
...
container_name= azure_storage_config['UGS_container_name'] 
local_directory = azure_storage_config['UGS_local_directory']
...
def upload_files_to_blob(local_directory, container_name):
 try:
    ...
    subject="Error: Issue in uploading CEG UGS File to Azure Storage"
    body=f"UGS Upload Job Failed: {e}"

...
from alarms_filter_files import filtered_files
...
container_name= azure_storage_config['alarms_container_name'] 
local_directory = azure_storage_config['alarms_local_directory']
    ...
    for root, _, files in os.walk(local_directory):
        for file in files:
         if(file in filtered_files_list):
            ...
            if file.endswith('.csv') or file.endswith(".CSV") or file.endswith('.xls') or file.endswith('.xlsx'):

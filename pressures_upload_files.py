...
from pressures_filter_files import filtered_files
...
container_name= azure_storage_config['pressures_container_name'] 
local_directory = azure_storage_config['pressures_local_directory']
...
def upload_files_to_blob(local_directory, container_name):
 try:
    ...
    subject="Error: Issue in uploading CEG Pressures File to Azure Storage"
    body=f"Pressures Upload Job Failed: {e}"
